...
const defaultAuthor = 'winter wang'
...
const reName = (name: string) => name === 'winter wang' ? 'dongmeng22' : name
    ...
    <section class="flex flex-col gap-y-[8px] overflow-hidden">
      ...
      <div>
        ...
        <span>
          ...
          >CC BY-NC-SA 4.0</a>
          许可协议。转载请注明来自
          <a href="https://dongmeng22.github.io/" rel="noreferrer" target="_blank">WinDocs</a></span>！
      </div>
    </section>
  </div>
</template>
