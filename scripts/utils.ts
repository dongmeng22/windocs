...
export const DOCS_URL = 'https://dongmeng22.github.io/docs'

export const DIR_ROOT = resolve(__dirname, '..')
export const DIR_SRC = resolve(__dirname, '../docs')

export function unique<T extends any[]>(a: T) {
...
async function fetchContributors(page = 1) {
  ...
  const data = await $fetch<{ login: string }[]>(`https://api.github.com/repos/dongmeng22/windocs/contributors?per_page=100&page=${page}`, {
    method: 'get',
    headers: {
